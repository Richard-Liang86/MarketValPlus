...
def update_stock(code):
    new_path = root_path + '/data/daily_data/stock_new/%s.csv' % code

    old_path = root_path + '/data/daily_data/stock/%s.csv' % code
...
if __name__ == '__main__':
    ...
    stock_code_list = get_stock_code_list_in_one_dir(root_path + '/data/daily_data/stock_new')  # 获取目录内的所有股票的文件的路径
